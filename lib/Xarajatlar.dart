...
// class _UmumiyXarajatlarPageState extends State<UmumiyXarajatlarPage> {
//   List<Map<String, dynamic>> xarajatlar = [
//     {"tur": "Elektr xarajati", "miqdor": 200.0, "kategoriya": "Kommunal"},
//     {"tur": "Hodimlarning oyligi", "miqdor": 1500.0, "kategoriya": "Oylik"},
//     {"tur": "Mahsulot xarajatlari", "miqdor": 800.0, "kategoriya": "Mahsulotlar"},
//   ];

//   void _addXarajat(String tur, double miqdor, String kategoriya) {
//     setState(() {
//       xarajatlar.add({"tur": tur, "miqdor": miqdor, "kategoriya": kategoriya});
//     });
//   }

//   void _deleteXarajat(int index) {
//     setState(() {
//       xarajatlar.removeAt(index);
//     });
//   }

//   void _editXarajat(int index, String newTur, double newMiqdor, String newKategoriya) {
//     setState(() {
//       xarajatlar[index] = {"tur": newTur, "miqdor": newMiqdor, "kategoriya": newKategoriya};
//     });
//   }
...
//     final TextEditingController kategoriyaController = TextEditingController();
...
//               ),
//               TextField(
//                 controller: kategoriyaController,
...
//             ElevatedButton(
//               onPressed: () {
//                 final String tur = turController.text;
//                 final double? miqdor = double.tryParse(miqdorController.text);
//                 final String kategoriya = kategoriyaController.text;

//                 if (tur.isNotEmpty && miqdor != null && kategoriya.isNotEmpty) {
//                   _addXarajat(tur, miqdor, kategoriya);
//                   Navigator.pop(context);
//                 }
//               },
...
//     final TextEditingController turController =
//         TextEditingController(text: xarajatlar[index]['tur']);
//     final TextEditingController miqdorController =
//         TextEditingController(text: xarajatlar[index]['miqdor'].toString());
//     final TextEditingController kategoriyaController =
//         TextEditingController(text: xarajatlar[index]['kategoriya']);
...
//                 if (tur.isNotEmpty && miqdor != null && kategoriya.isNotEmpty) {
//                   _editXarajat(index, tur, miqdor, kategoriya);
//                   Navigator.pop(context);
//                 }
//               },
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Umumiy Xarajatlar'),
//         backgroundColor: Colors.white,
//       ),
//       body: ListView.builder(
//         itemCount: xarajatlar.length,
//         itemBuilder: (context, index) {
//           return Card(
//             child: ListTile(
//               title: Text(xarajatlar[index]['tur']),
//               subtitle: Text('Kategoriya: ${xarajatlar[index]['kategoriya']}'),
//               trailing: Row(
//                 mainAxisSize: MainAxisSize.min,
//                 children: [
//                   IconButton(
